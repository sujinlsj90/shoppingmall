...
<body>
	...
	<div id="container">
		<!-- 상단 중앙2 시작 -->
				<div class="join">
					<form name="join_form" action="${path}/loginAction2.do" method="post" onsubmit = "return signInCheck();">
					...
					<c:if test="${sessionScope.customerId != null}">
						<div class="form-floating">
								...
								<br>
						<div class="form-floating">
									<input type="button" class = "button_login" value="창닫기" onclick = "self.close(); opener.location.reload();">
