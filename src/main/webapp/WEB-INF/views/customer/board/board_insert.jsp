	...
	<!-- header 끝 -->
	 ...
	 <!--breadcrumbs area start-->
	    ...
	    <div class="boardlist_area" style = "max-width:900px; margin:auto;">
	   		 <div class="container">  
	   		 	 <form class = "board_write" name = "insertForm" method = "post">
                    	...
                    	<div class="col-12">
                       	 <div class="board_desc">
                       	 	<div class="board_page" style = "font-family:'맑은 고딕';"> 
                       	 		<div class="mb-3">
								 --- WRITER   <input type="text" id="writer" name = "writer" value = "${dto.writer}">
								  </div>
								  <div class="mb-3">
								 PASSWORD <input type="password" id="password" name = "password" placeholder="password" value = "${dto.password}">
								 </div>
								<div class="mb-3">
							 ...
							 <div class= "board_submit">
	                       	 	<input type = "button" class="btn btn-outline-secondary btn-sm" id = "btnSave" style = "float:right;" value = "write">
	                       	 	<input type = "reset" class="btn btn-outline-secondary btn-sm" style = "float:right;" value = "reset">
